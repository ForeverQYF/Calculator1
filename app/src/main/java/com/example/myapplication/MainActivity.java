...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener listener= new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            int id = view.getId();
            if (id == R.id.btn0 || id == R.id.btn1 || id == R.id.btn2 || id == R.id.btn3 || id == R.id.btn4 || id == R.id.btn5 || id == R.id.btn6 || id == R.id.btn7 || id == R.id.btn8 || id == R.id.btn9 || id == R.id.btndot) {
                if (clear_flag) {
                    clear_flag = false;
                    editText.setText("");//赋值为空
                }
                editText.setText(input + ((Button) view).getText());//结果集就为本身
            } else if (id == R.id.btnadd || id == R.id.btnsub || id == R.id.btncheng || id == R.id.btnchu) {
                if (clear_flag) {
                    clear_flag = false;
                    input = "";
                    editText.setText("");
